    ...
    def train(self,
        ...
        if dev_dataset is not None:
            dev_loader = DataLoader(
                dataset=dev_dataset, batch_size=dev_batch_size, shuffle=False, num_workers=num_workers)
            early_stopping = EarlyStopping(
                not_improve_step=not_imporve_step, verbose=True)
        ...
        for i in range(epochs):
            ...
            for batch in tqdm(train_loader):
                ...
                self.log.write('loss/training_loss',
                               step_loss.item(), global_step)
            ...
            if dev_loader is not None:
                ...
                with torch.no_grad():
                    ...
                    for batch in tqdm(dev_loader):
                        ...
                        self.log.write('loss/validation_loss',
                                       step_loss.item(), val_global_step)
                ...
                print('epoch - {0}, global_step:{1}, train_loss:{2:.2f}, dev_loss:{3:.2f}'.format(
                    i+1, global_step, train_loss, dev_loss))
                ...
                print(
                    'epoch - {0},global_step:{1}, train_loss:{2:.2f}'.format(i+1, global_step, train_loss))
