...
class Yolov3Trainer(BaseTrainer):
    ...
    def __init__(self, model, optimizer, criterion, metric, device, anchors, log=None):
        super(Yolov3Trainer, self).__init__(
            model, optimizer, criterion, metric, device, log)
    ...
    def iter(self, batch):
        ...
        output_prediction = self.model(image)
    ...
    def train(self,
        ...
        for i in range(epochs):
            ...
            for batch in tqdm(train_loader):
                ...
                self.log.write('xy_loss/training_xy_loss',
            ...
            if dev_loader is not None:
                ...
                with torch.no_grad():
                    ...
                    for batch in tqdm(dev_loader):
                        ...
                        self.log.write('xy_loss/dev_xy_loss',
                                       xy_loss.item(), val_global_step)
